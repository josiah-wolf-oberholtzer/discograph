...
class ArtistRole(Model, mongoengine.EmbeddedDocument):
    ...
    _available_credit_roles = collections.OrderedDict([
    ...
    def get_multiselect_mapping(cls):
        ...
        category_names = {
            ...
            cls.Category.DJ_MIX: 'DJ Mix',
            cls.Category.FEATURING_AND_PRESENTING: 'Featuring & Presenting',
            cls.Category.MANAGEMENT: 'Management',
            cls.Category.PRODUCTION: 'Production',
            cls.Category.RELATION: 'Structural Relationships',
            cls.Category.REMIX: 'Remix',
            cls.Category.TECHNICAL: 'Technical',
            cls.Category.VISUAL: 'Visual',
            cls.Category.VOCAL: 'Vocal',
            cls.Category.WRITING_AND_ARRANGEMENT: 'Writing & Arrangement',
            }
        subcategory_names = {
            cls.Subcategory.DRUMS_AND_PERCUSSION: 'Drums & Percussion',
            cls.Subcategory.KEYBOARD: 'Keyboard',
            cls.Subcategory.OTHER_MUSICAL: 'Other Musical',
            cls.Subcategory.STRINGED_INSTRUMENTS: 'String Instruments',
            cls.Subcategory.TECHNICAL_MUSICAL: 'Technical Musical',
            cls.Subcategory.TUNED_PERCUSSION: 'Tuned Percussion',
            cls.Subcategory.WIND_INSTRUMENTS: 'Wind Instruments',
            }
        ...
        for role_name, categories in cls._available_credit_roles.items():
            ...
            if len(categories) == 1:
                ...
                category_name = subcategory_names[categories[1]]
