    ...
    def test_5(self):
        ...
        assert network == {
            ...
            'nodes': (
                ...
                {'distance': 2, 'group': None, 'id': 453969, 'key': 'artist-453969', 'missing': 2, 'name': 'Jerry Hubbard', 'size': 0, 'type': 'artist'},
                {'distance': 1, 'group': 1, 'id': 2561672, 'key': 'artist-2561672', 'missing': 0, 'name': 'Original 7ven, The', 'size': 7, 'type': 'artist'},
                {'distance': 1, 'group': None, 'id': 157, 'key': 'label-157', 'missing': 1756, 'name': 'Reprise Records', 'size': 10, 'type': 'label'},
                {'distance': 1, 'group': None, 'id': 1000, 'key': 'label-1000', 'missing': 5056, 'name': 'Warner Bros. Records', 'size': 45, 'type': 'label'},
                {'distance': 2, 'group': None, 'id': 1614, 'key': 'label-1614', 'missing': 22691, 'name': 'Arcade', 'size': 51, 'type': 'label'},
                {'distance': 2, 'group': None, 'id': 3072, 'key': 'label-3072', 'missing': 5951, 'name': 'CBS', 'size': 77, 'type': 'label'},
                {'distance': 2, 'group': None, 'id': 4243, 'key': 'label-4243', 'missing': 6570, 'name': 'DMC', 'size': 11, 'type': 'label'},
                {'distance': 2, 'group': None, 'id': 5115, 'key': 'label-5115', 'missing': 333, 'name': 'Paisley Park', 'size': 0, 'type': 'label'},
                {'distance': 2, 'group': None, 'id': 29034, 'key': 'label-29034', 'missing': 1, 'name': 'Pie Records', 'size': 0, 'type': 'label'},
                {'distance': 2, 'group': None, 'id': 33244, 'key': 'label-33244', 'missing': 2233, 'name': 'Rhino Records (2)', 'size': 19, 'type': 'label'},
                {'distance': 1, 'group': None, 'id': 40396, 'key': 'label-40396', 'missing': 3486, 'name': 'WEA', 'size': 17, 'type': 'label'},
                {'distance': 2, 'group': None, 'id': 41256, 'key': 'label-41256', 'missing': 1760, 'name': 'Warner Special Products', 'size': 0, 'type': 'label'},
                {'distance': 2, 'group': None, 'id': 47852, 'key': 'label-47852', 'missing': 67, 'name': 'The Power Of Funk & Soul', 'size': 0, 'type': 'label'},
                {'distance': 2, 'group': None, 'id': 54908, 'key': 'label-54908', 'missing': 599, 'name': 'Electrola', 'size': 0, 'type': 'label'},
                {'distance': 2, 'group': None, 'id': 71233, 'key': 'label-71233', 'missing': 695, 'name': 'Hi-Bias Records', 'size': 2, 'type': 'label'},
                {'distance': 1, 'group': None, 'id': 192270, 'key': 'label-192270', 'missing': 78, 'name': 'Not On Label (Ben Liebrand)', 'size': 0, 'type': 'label'},
                {'distance': 2, 'group': None, 'id': 226407, 'key': 'label-226407', 'missing': 8, 'name': 'i-D Magazine', 'size': 0, 'type': 'label'},
                ),
            }